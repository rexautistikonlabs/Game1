...
struct LetterRenderer {
    ...
    private var orgNameStyle: TextStyle {
        TextStyle(font: TextStyle.serif(16, weight: .semibold), color: .black, kerning: -0.2)
    }

    private var orgNameReversedStyle: TextStyle {
        TextStyle(font: TextStyle.serif(16, weight: .semibold), color: .white, kerning: -0.2)
    }
    ...
    private var taglineStyle: TextStyle {
        TextStyle(font: TextStyle.serif(9.5, weight: .regular), color: UIColor(white: 0.45, alpha: 1))
    }
    ...
    private var bodyStyle: TextStyle {
        ...
        TextStyle(font: TextStyle.serif(11), color: UIColor(white: 0.08, alpha: 1), lineHeightMultiple: 1.4, paragraphSpacing: 11)
    }

    private var bodyEmphasisStyle: TextStyle {
        TextStyle(font: TextStyle.serif(11, weight: .semibold), color: .black, lineHeightMultiple: 1.4)
    }

    private var addressStyle: TextStyle {
        TextStyle(font: TextStyle.serif(11), color: UIColor(white: 0.12, alpha: 1), lineHeightMultiple: 1.3)
    }
    ...
    private func drawSubstantiation(_ canvas: PDFCanvas) {
        ...
        var style = bodyStyle
        style.font = TextStyle.serif(9.5)
